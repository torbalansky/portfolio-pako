    ...
    <nav className={`py-5 top-0 z-50 sticky ${navbarColor}`}>
      <div className='container flex justify-between items-center'>
        <div className={`flex items-center gap-1 font-semibold text-2xl ${iconColor}`}>
          <TbHexagonLetterP className="rotate-360 cursor-pointer" onClick={scrollToTop} />
          <TbHexagonLetterA className="rotate-360 cursor-pointer" onClick={scrollToTop} />
          <TbHexagonLetterC className="rotate-360 cursor-pointer" onClick={scrollToTop} />
          <GiNestedHexagons className="rotate-360 cursor-pointer" onClick={scrollToTop} />
        </div>
